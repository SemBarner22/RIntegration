...
public abstract class AbstractBoolOperation1 extends TripleExpression {
    private TripleExpression firstExpression, secondExpression;

    public AbstractBoolOperation1(TripleExpression firstExpression, TripleExpression secondExpression) throws EvaluatingException {
